...
| **perSimplex**         | `integer`  | The index of the accessor that contains the per-simplex data for this channel.         | No per simplex data.               |
